...
export default function AdminLoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await loginWithEmail(emailInput.value, passwordInput.value, 'admin');
        ...
        <div className="flex-1 flex items-center justify-center p-4 py-12 bg-slate-900 min-h-screen">
            ...
            >
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="email"
                                placeholder="admin@localgift.app"
                                className="w-full pl-10 pr-4 py-2.5 border border-slate-600 rounded-xl bg-slate-700 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div className="bg-indigo-900/30 border border-indigo-700/50 rounded-xl p-3 mt-4">
                        <p className="text-xs text-indigo-300 flex items-center gap-2">
                            <ShieldCheck size={14} /> You will be authenticated with <strong>admin privileges</strong>
                        </p>
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-2.5 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-500 transition-all mt-4 shadow-lg shadow-indigo-600/30 disabled:opacity-50"
                    >
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full py-2.5 border border-slate-600 rounded-xl flex justify-center items-center gap-2 hover:bg-slate-700 text-white font-medium transition-all disabled:opacity-50"
                >
                ...
                <div className="mt-6 text-center space-y-2">
                    <p className="text-sm text-slate-500">
                        ...
                        <Link href="/admin-signup" className="text-indigo-400 font-semibold hover:underline">Register as Admin</Link>
                    </p>
